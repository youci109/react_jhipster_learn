    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="reactJhipsterLearnApp.bloodPressure.home.createOrEditLabel">Create or edit a BloodPressure</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : bloodPressureEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="blood-pressure-id">ID</Label>
                ...
                <AvGroup>
                  <Label for="blood-pressure-user">User</Label>
